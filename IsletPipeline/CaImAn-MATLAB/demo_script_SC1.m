function  demo_script_SC1(nam)
%DEMO_SCRIPT_SC1 此处显示有关此函数的摘要
%   此处显示详细说明
% nam = 'D:\Image\3.0-惠霞数据\CNMF\20200707_1_20m_3G_160m_10G_3s-1_raw-MED1-BGR-NoRMC.tif';          % insert path to tiff stack here
...
%% Set parameters
K = 90;                                           % number of components to be found
...
options = CNMFSetParms(...   
    ...
    'merge_thr',0.40,...                        % merging threshold  0.8
    'nb',1,...                                  % number of background components   2 
    'min_SNR',0.01,...                             % minimum SNR threshold   3
    'space_thresh',0.5,...                      % space correlation threshold 0.5
    'cnn_thr',0.01...                            % threshold for CNN classifier  0.2  
    );
% 
...
%     'p',p,...                                   % order of AR dynamics    
%     'gSig',tau,...                              % half size of neuron
%     'merge_thr',0.50,...                        % merging threshold  0.8
%     'nb',2,...                                  % number of background components    
%     'min_SNR',5,...                             % minimum SNR threshold
%     'space_thresh',0.4,...                      % space correlation threshold   0.5
...
save([nam(1:end-4),'_Aor.mat'],'A_or');
save([nam(1:end-4),'_Cor.mat'],'C_or');
save([nam(1:end-4),'_Sor.mat'],'S_or');
save([nam(1:end-4),'_Por.mat'],'P_or');
end
