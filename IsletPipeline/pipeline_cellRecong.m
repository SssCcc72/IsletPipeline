...
%% load file
gcp;                            % start cluster
addpath(genpath('CaImAn-MATLAB\utilities'));
addpath(genpath('CaImAn-MATLAB\deconvolution'));
addpath('../CaImAn-MATLAB/SC_Add');
path = 'D:\SC-Master\6.0-°ßÂíÓãÒÈµº\0903_test\0307';
name = '0307_5m_C1-1_raw-NoRMC.tif';
nam = [path,'\',name];
% nam = 'D:\SC-Master\6.0-°ßÂíÓãÒÈµºÏîÄ¿\1.0-Image-Processes\tmp\0317_5m_C1.0-BGR.tif_Cor-NoRMC.tif';          % insert path to tiff stack here
...
options = CNMFSetParms(...   
    ...
    'gSig',tau,... s                             % half size of neuron
    'merge_thr',0.15,...                        % merging threshold  0.8
    'nb',1,...                                  % number of background components   2 
    'min_SNR',0.001,...                             % minimum SNR threshold   3
    'space_thresh',0.2,...                      % space correlation threshold 0.5
